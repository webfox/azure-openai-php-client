...
test('transcribe to text', function () {
    ...
    ], \Webfox\AzureOpenAI\ValueObjects\Transporter\Response::from(audioTranscriptionText(), metaHeaders()), validateParams: false);
...
test('transcribe to json', function () {
    ...
    ], \Webfox\AzureOpenAI\ValueObjects\Transporter\Response::from(audioTranscriptionJson(), metaHeaders()), validateParams: false);
...
test('transcribe to verbose json', function () {
    ...
    ], \Webfox\AzureOpenAI\ValueObjects\Transporter\Response::from(audioTranscriptionVerboseJson(), metaHeaders()), validateParams: false);
...
test('translate to text', function () {
    $client = mockClient('POST', 'audio/translations', [
        ...
        'model' => 'whisper-1',
        'response_format' => 'text',
    ], \Webfox\AzureOpenAI\ValueObjects\Transporter\Response::from(audioTranslationText(), metaHeaders()), validateParams: false);
...
test('translate to json', function () {
    $client = mockClient('POST', 'audio/translations', [
        ...
        'model' => 'whisper-1',
        'response_format' => 'json',
    ], \Webfox\AzureOpenAI\ValueObjects\Transporter\Response::from(audioTranslationJson(), metaHeaders()), validateParams: false);
...
test('translate to verbose json', function () {
    $client = mockClient('POST', 'audio/translations', [
        ...
        'model' => 'whisper-1',
        'response_format' => 'verbose_json',
    ], \Webfox\AzureOpenAI\ValueObjects\Transporter\Response::from(audioTranslationVerboseJson(), metaHeaders()), validateParams: false);
