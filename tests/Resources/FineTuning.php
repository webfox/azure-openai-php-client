...
test('create job', function () {
    $client = mockClient('POST', 'fine_tuning/jobs', [
        ...
        'suffix' => null,
    ], \Webfox\AzureOpenAI\ValueObjects\Transporter\Response::from(fineTuningJobCreateResource(), metaHeaders()));
...
test('list jobs', function () {
    $client = mockClient('GET', 'fine_tuning/jobs', [], \Webfox\AzureOpenAI\ValueObjects\Transporter\Response::from(fineTuningJobListResource(), metaHeaders()));
...
test('list jobs with params', function () {
    $client = mockClient('GET', 'fine_tuning/jobs', ['limit' => 3], \Webfox\AzureOpenAI\ValueObjects\Transporter\Response::from(fineTuningJobListResource(), metaHeaders()));
...
test('retrieve job', function () {
    $client = mockClient('GET', 'fine_tuning/jobs/ftjob-AF1WoRqd3aJAHsqc9NY7iL8F', [], \Webfox\AzureOpenAI\ValueObjects\Transporter\Response::from(fineTuningJobRetrieveResource(), metaHeaders()));
...
test('cancel job', function () {
    $client = mockClient('POST', 'fine_tuning/jobs/ftjob-AF1WoRqd3aJAHsqc9NY7iL8F/cancel', [], \Webfox\AzureOpenAI\ValueObjects\Transporter\Response::from([...fineTuningJobRetrieveResource(), 'status' => 'cancelled'], metaHeaders()));
...
test('list job events', function () {
    $client = mockClient('GET', 'fine_tuning/jobs/ftjob-AF1WoRqd3aJAHsqc9NY7iL8F/events', [], \Webfox\AzureOpenAI\ValueObjects\Transporter\Response::from(fineTuningJobListEventsResource(), metaHeaders()));
    ...
    expect($result->data[0])
        ...
        ->level->toBe(\Webfox\AzureOpenAI\Enums\FineTuning\FineTuningEventLevel::Info)
...
test('list job events with params', function () {
    $client = mockClient('GET', 'fine_tuning/jobs/ftjob-AF1WoRqd3aJAHsqc9NY7iL8F/events', ['limit' => 3], \Webfox\AzureOpenAI\ValueObjects\Transporter\Response::from(fineTuningJobListEventsResource(), metaHeaders()));
